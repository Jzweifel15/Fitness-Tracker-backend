...
user1_bmi_1 = BodyMassIndex.create!(weight: 220, height: 74, bmi: 28, user_id: user1.id, created_at: "2021-01-01T07:21:33.627z", updated_at: "2021-01-01T07:21:33.627z")
user1_bmi_2 = BodyMassIndex.create!(weight: 225, height: 74, bmi: 29, user_id: user1.id, created_at: "2021-02-01T07:21:33.627z", updated_at: "2021-02-01T07:21:33.627z")
user1_bmi_3 = BodyMassIndex.create!(weight: 210, height: 74, bmi: 27, user_id: user1.id, created_at: "2021-03-01T07:21:33.627z", updated_at: "2021-03-01T07:21:33.627z")
